# Package Documentation for github.com/ugorji/go-simplewebsite/simplewebsite
...
metadata. Instead, the name is got from the name of the contents file, the
title is the first header in the file, and summary is the first paragraph,
